...
function Register() {
  ...
  const [fileError, setFileError] = useState(""); // File-specific errors
  const [user, setUser] = useState({
    ...
    isSeller: false,
    desc: "",
    phoneCode: "", // To store the selected country's phone code
  });
  ...
  const validatePassword = (password) => {
    ...
    if (/^0+$/.test(password)) return "Password cannot consist only of zeros."; // New validation rule
    return "";
  };
      ...
      <form onSubmit={handleSubmit}>
        <div className="left">
          ...
          <input 
            ...
            accept="image/jpeg, image/jpg, image/png" // Restrict file types here
          />
